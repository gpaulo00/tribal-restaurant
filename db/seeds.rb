...
5.times do |i|
    Comment.create(
        name: "Gustavo Paulo",
        comment: "Es mi restaurante preferido!",
        restaurant_id: i,
    )
end

# images
Image.create(restaurant_id: 1, path: '/restaurants/eleven.jpg')
Image.create(restaurant_id: 1, path: '/restaurants/eleven2.jpg')
Image.create(restaurant_id: 1, path: '/restaurants/eleven3.jpg')

Image.create(restaurant_id: 2, path: '/restaurants/osteria.jpg')
Image.create(restaurant_id: 2, path: '/restaurants/osteria2.jpg')
Image.create(restaurant_id: 2, path: '/restaurants/osteria3.jpg')

Image.create(restaurant_id: 3, path: '/restaurants/celler.jpg')
Image.create(restaurant_id: 3, path: '/restaurants/celler1.jpg')
Image.create(restaurant_id: 3, path: '/restaurants/celler3.jpg')

Image.create(restaurant_id: 4, path: '/restaurants/mirazur.jpg')
Image.create(restaurant_id: 4, path: '/restaurants/mirazur2.jpg')
Image.create(restaurant_id: 4, path: '/restaurants/mirazur3.jpg')

Image.create(restaurant_id: 5, path: '/restaurants/central.jpg')